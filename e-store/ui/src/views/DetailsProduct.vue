            ...
            <div class="box">
                <div class="images">
                    <div class="img-holder active">
                        <img :src="imges + products.imge" style="width: 500px; height: 400px" />
                    </div>
                    <div class="img-holder">
                        <img :src="imges + products.imge" style="width: 164px; height: 150px" />
                    </div>
                    <div class="img-holder">
                        <img :src="imges + products.imge" style="width: 164px; height: 150px" />
                    </div>
                ...
                <div class="basic-info">
                    ...
                    <div class="rate">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            class="bi bi-star" viewBox="0 0 16 16" v-for="(star, index) in 5" :key="index"
                            @click="rateProduct(index + 1) + rate()" :class="{ active: index < rating }">
                            <path
